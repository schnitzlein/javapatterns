...
public abstract class CopyOfKonto {
  ...
  @*/
  public CopyOfKonto(String kontoinhaber, double startkapital, double dispo){
  ...
  @   buchungen.add(new Buchung(betrag, "von: "+einzahlerName) ) &&
  ...
  /*@ requires 0 < betrag && gesperrt == false && aktiv == true &&
  @   empfaengerName != null && ((kontostand - betrag) > dispo) == true;
  @ assignable kontostand;
  @ ensures kontostand == \old(kontostand) - betrag &&
  @   kontoinhaber.equals(kontoinhaber) &&
  @    buchungen.add(new Buchung(betrag, "nach: "+empfaengerName)) &&
  @   buchungen.size() == \old(buchungen.size()) +1 &&
  @   \result == true;
  @*/
